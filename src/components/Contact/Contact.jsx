...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_ak0ix5o", // Replace with your EmailJS Service ID
        "template_8djrqwb", // Replace with your EmailJS Template ID
        form.current,
        "PCz5wsES63NLXuwj-", // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
